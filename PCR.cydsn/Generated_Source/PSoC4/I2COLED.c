...
static void I2COLED_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2COLED_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            hsiomSel[I2COLED_RX_SCL_MOSI_PIN_INDEX] = I2COLED_HSIOM_I2C_SEL;
            hsiomSel[I2COLED_TX_SDA_MISO_PIN_INDEX] = I2COLED_HSIOM_I2C_SEL;
        ...
        {
            hsiomSel[I2COLED_RX_SCL_MOSI_PIN_INDEX] = I2COLED_HSIOM_SPI_SEL;
            hsiomSel[I2COLED_TX_SDA_MISO_PIN_INDEX] = I2COLED_HSIOM_SPI_SEL;
            hsiomSel[I2COLED_CTS_SCLK_PIN_INDEX] = I2COLED_HSIOM_SPI_SEL;
            ...
            if (I2COLED_SPI_SLAVE == subMode)
            {
                ...
                pinsDm[I2COLED_CTS_SCLK_PIN_INDEX] = I2COLED_PIN_DM_DIG_HIZ;

            #if (I2COLED_RTS_SS0_PIN)
                /* Only SS0 is valid choice for Slave */
                hsiomSel[I2COLED_RTS_SS0_PIN_INDEX] = I2COLED_HSIOM_SPI_SEL;
                pinsDm  [I2COLED_RTS_SS0_PIN_INDEX] = I2COLED_PIN_DM_DIG_HIZ;
            ...
            else /* (Master) */
            {
                ...
                pinsDm[I2COLED_CTS_SCLK_PIN_INDEX] = I2COLED_PIN_DM_STRONG;

            #if (I2COLED_RTS_SS0_PIN)
                hsiomSel [I2COLED_RTS_SS0_PIN_INDEX] = I2COLED_HSIOM_SPI_SEL;
                pinsDm   [I2COLED_RTS_SS0_PIN_INDEX] = I2COLED_PIN_DM_STRONG;
                pinsInBuf |= I2COLED_RTS_SS0_PIN_MASK;
            #endif /* (I2COLED_RTS_SS0_PIN) */
                ...
                pinsInBuf |= I2COLED_CTS_SCLK_PIN_MASK;
        ...
        else /* UART */
        {
            ...
            {
                /* SmartCard */
                hsiomSel[I2COLED_TX_SDA_MISO_PIN_INDEX] = I2COLED_HSIOM_UART_SEL;
                pinsDm  [I2COLED_TX_SDA_MISO_PIN_INDEX] = I2COLED_PIN_DM_OD_LO;
            }
            else /* Standard or IrDA */
            {
                ...
                {
                    hsiomSel[I2COLED_RX_SCL_MOSI_PIN_INDEX] = I2COLED_HSIOM_UART_SEL;
                    pinsDm  [I2COLED_RX_SCL_MOSI_PIN_INDEX] = I2COLED_PIN_DM_DIG_HIZ;
                }
                ...
                if (I2COLED_UART_MODE_STD == subMode)
                {
                    if (0u != (I2COLED_UART_CTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[I2COLED_CTS_SCLK_PIN_INDEX] = I2COLED_HSIOM_UART_SEL;
                        pinsDm  [I2COLED_CTS_SCLK_PIN_INDEX] = I2COLED_PIN_DM_DIG_HIZ;
                    }
                    ...
                    if (0u != (I2COLED_UART_RTS_PIN_ENABLE & uartEnableMask))
                    {
                        ...
                        hsiomSel[I2COLED_RTS_SS0_PIN_INDEX] = I2COLED_HSIOM_UART_SEL;
                        pinsDm  [I2COLED_RTS_SS0_PIN_INDEX] = I2COLED_PIN_DM_STRONG;
    ...
    #if (I2COLED_CTS_SCLK_PIN)
        I2COLED_SET_HSIOM_SEL(I2COLED_CTS_SCLK_HSIOM_REG,
                                       I2COLED_CTS_SCLK_HSIOM_MASK,
                                       I2COLED_CTS_SCLK_HSIOM_POS,
                                       hsiomSel[I2COLED_CTS_SCLK_PIN_INDEX]);

        I2COLED_uart_cts_spi_sclk_SetDriveMode((uint8) pinsDm[I2COLED_CTS_SCLK_PIN_INDEX]);

        I2COLED_SET_INP_DIS(I2COLED_uart_cts_spi_sclk_INP_DIS,
                                     I2COLED_uart_cts_spi_sclk_MASK,
                                     (0u != (pinsInBuf & I2COLED_CTS_SCLK_PIN_MASK)));
    #endif /* (I2COLED_CTS_SCLK_PIN) */

    #if (I2COLED_RTS_SS0_PIN)
        I2COLED_SET_HSIOM_SEL(I2COLED_RTS_SS0_HSIOM_REG,
                                       I2COLED_RTS_SS0_HSIOM_MASK,
                                       I2COLED_RTS_SS0_HSIOM_POS,
                                       hsiomSel[I2COLED_RTS_SS0_PIN_INDEX]);

        I2COLED_uart_rts_spi_ss0_SetDriveMode((uint8) pinsDm[I2COLED_RTS_SS0_PIN_INDEX]);

        I2COLED_SET_INP_DIS(I2COLED_uart_rts_spi_ss0_INP_DIS,
                                     I2COLED_uart_rts_spi_ss0_MASK,
                                     (0u != (pinsInBuf & I2COLED_RTS_SS0_PIN_MASK)));
    #endif /* (I2COLED_RTS_SS0_PIN) */
