...
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)0x48000228u)
...
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)0x48000248u)
...
uint8 CYXDATA * const CYCODE AMux_Adc_CYAMUXSIDE_A__addrTable[6] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_Adc_CYAMUXSIDE_A__maskTable[6] = {
	0x40u, 0x40u, 
	0x10u, 0x10u, 
	0x04u, 0x00u, 
};
...
/*******************************************************************************
* Function Name: AMux_Adc_CYAMUXSIDE_A_Set
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void AMux_Adc_CYAMUXSIDE_A_Set(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*AMux_Adc_CYAMUXSIDE_A__addrTable[channel] |= AMux_Adc_CYAMUXSIDE_A__maskTable[channel];
		channel++;
		*AMux_Adc_CYAMUXSIDE_A__addrTable[channel] |= AMux_Adc_CYAMUXSIDE_A__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: AMux_Adc_CYAMUXSIDE_A_Unset
********************************************************************************
* Summary:
...
*
*******************************************************************************/
void AMux_Adc_CYAMUXSIDE_A_Unset(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*AMux_Adc_CYAMUXSIDE_A__addrTable[channel] &= (uint8)~AMux_Adc_CYAMUXSIDE_A__maskTable[channel];
		channel++;
		*AMux_Adc_CYAMUXSIDE_A__addrTable[channel] &= (uint8)~AMux_Adc_CYAMUXSIDE_A__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE AMux_Adc_CYAMUXSIDE_B__addrTable[6] = {
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_Adc_CYAMUXSIDE_B__maskTable[6] = {
	0x08u, 0x80u, 
	0x20u, 0x20u, 
	0x40u, 0x00u, 
};
...
/*******************************************************************************
* Function Name: AMux_Adc_CYAMUXSIDE_B_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void AMux_Adc_CYAMUXSIDE_B_Set(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*AMux_Adc_CYAMUXSIDE_B__addrTable[channel] |= AMux_Adc_CYAMUXSIDE_B__maskTable[channel];
		channel++;
		*AMux_Adc_CYAMUXSIDE_B__addrTable[channel] |= AMux_Adc_CYAMUXSIDE_B__maskTable[channel];
	}
}
...
/*******************************************************************************
* Function Name: AMux_Adc_CYAMUXSIDE_B_Unset
********************************************************************************
* Summary:
*  This function is used to clear a particular channel from being active on the
*  AMux.
...
*
*******************************************************************************/
void AMux_Adc_CYAMUXSIDE_B_Unset(uint8 channel)
{
	if (channel < 3)
	{
		channel += channel;
		*AMux_Adc_CYAMUXSIDE_B__addrTable[channel] &= (uint8)~AMux_Adc_CYAMUXSIDE_B__maskTable[channel];
		channel++;
		*AMux_Adc_CYAMUXSIDE_B__addrTable[channel] &= (uint8)~AMux_Adc_CYAMUXSIDE_B__maskTable[channel];
	}
}
...
/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
uint8 CYXDATA * const CYCODE AMux_Idac__addrTable[4] = {
	(uint8 CYXDATA *)CYREG_DAC0_SW3, (uint8 CYXDATA *)CY_AMUX_UNUSED, 
	(uint8 CYXDATA *)CYREG_PRT0_AMUX, (uint8 CYXDATA *)CYREG_DAC0_SW3, 
};

/* This is an implementation detail of the AMux. Code that depends on it may be
   incompatible with other versions of PSoC Creator. */
const uint8 CYCODE AMux_Idac__maskTable[4] = {
	0x80u, 0x00u, 
	0x80u, 0x10u, 
};

/*******************************************************************************
* Function Name: AMux_Idac_Set
********************************************************************************
* Summary:
*  This function is used to set a particular channel as active on the AMux.
*
...
*
*******************************************************************************/
void AMux_Idac_Set(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*AMux_Idac__addrTable[channel] |= AMux_Idac__maskTable[channel];
		channel++;
		*AMux_Idac__addrTable[channel] |= AMux_Idac__maskTable[channel];
	}
}
...
*
*******************************************************************************/
void AMux_Idac_Unset(uint8 channel)
{
	if (channel < 2)
	{
		channel += channel;
		*AMux_Idac__addrTable[channel] &= (uint8)~AMux_Idac__maskTable[channel];
		channel++;
		*AMux_Idac__addrTable[channel] &= (uint8)~AMux_Idac__maskTable[channel];
	}
}
